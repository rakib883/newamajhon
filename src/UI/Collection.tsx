        ...
        <div className="content-area">
            ...
            <div className="product-area">
                <div className="product flex justify-center items-end gap-8">
                    <h1 onClick={()=>tabData(1)} className={`${tab === 1 ? "bg-[#537BDE] p-1 ": ""} text-[12px] md:text-[18px] uppercase font-mainFont cursor-pointer`}>New arrivals</h1>
                    <h1 onClick={()=>tabData(2)} className={`${tab === 2 ? "bg-[#537BDE] p-1 " : ""} text-[12px]  md:text-[18px] uppercase font-mainFont cursor-pointer`}>Feture</h1>
                    <h1 onClick={()=>tabData(3)} className="text-[12px] md:text-[18px] uppercase font-mainFont cursor-pointer">best sellers</h1>
                </div>
